...
const LOADING_SLIDES = [
  {
    key: "earned",
    type: "card" as const,
    title: (<>Beer Cafe has earned<br /><span className="loading-highlight">₹ 70 lakhs</span> through<br />Membership</>),
    img: loadingCard1,
  ...
  },
  {
    key: "return",
    type: "chart" as const,
    title: (<>Customers return upto<br /><span className="loading-highlight">10X faster</span> after<br />purchasing membership!</>),
    img: loadingChart1,
  ...
  },
  {
    key: "coffee-pass",
    type: "card" as const,
    title: (<><span className="loading-highlight">800+ Customers</span> have bought<br />the Monthly Coffee Pass at<br />Noa by Nutcracker</>),
    img: loadingCard2,
    imgClass: "loading-card-img",
  },
  {
    key: "spend-more",
    type: "chart" as const,
    title: (<>Members spend<br /><span className="loading-highlight">22-35% more</span><br />than non-members</>),
    img: loadingChart2,
    imgClass: "loading-chart-img",
  },
  {
    key: "vip-perks",
    type: "card" as const,
    title: (<>Restaurant of all types are<br />launching exclusive<br /><span className="loading-highlight">VIP perks</span> for their regulars</>),
    img: loadingCard3,
    imgClass: "loading-card-img",
  },
];
